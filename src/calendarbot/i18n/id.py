...
""",
    ...
    settings=SettingsTranslations(
        ...
        connect_outlook_button="🔗 Hubungkan Outlook Calendar",
        outlook_disconnected="✅ Outlook Calendar berhasil diputus.\nGunakan /connectoutlook untuk menghubungkan kembali.",
        no_outlook_connected="Tidak ada kalender Outlook yang terhubung.",
        connect_outlook_mode_title="**Hubungkan Outlook Calendar**\n\nPilih mode koneksi:",
        outlook_connected_status="**Outlook Calendar Terhubung** ✅\n\nMode saat ini: {mode}\n\nAnda dapat mengubah mode atau memutuskan koneksi di bawah:",
    ...
    meetings=MeetingsTranslations(
        ...
        close_button="✖️ Tutup",
        edit_button="✏️ Edit",
        cancel_meeting_button="🗑️ Batalkan",
        back_to_list_button="↩️ Kembali ke Daftar",
        closed="Daftar rapat ditutup.",
        # Edit menu
        edit_menu_title="✏️ **Edit Rapat**\n\nPilih bidang untuk diedit:",
        edit_title_btn="📝 Judul",
        edit_time_btn="🕐 Waktu",
        edit_date_btn="📅 Tanggal",
