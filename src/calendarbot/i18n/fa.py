...
""",
    ...
    settings=SettingsTranslations(
        ...
        outlook_calendar_label="تقویم Outlook",
        ...
        connect_outlook_button="🔗 اتصال تقویم Outlook",
        outlook_disconnected="✅ تقویم Outlook با موفقیت قطع شد.\nبرای اتصال مجدد از /connectoutlook استفاده کنید.",
        no_outlook_connected="هیچ تقویم Outlook متصل نیست.",
        connect_outlook_mode_title="**اتصال به Outlook Calendar**\n\nحالت اتصال را انتخاب کنید:",
        outlook_connected_status="**تقویم Outlook متصل شد** ✅\n\nحالت فعلی: {mode}\n\nمی‌توانید حالت را تغییر دهید یا قطع کنید:",
    ...
    inline=InlineTranslations(
        ...
        auto_teams_meeting="📹 Microsoft Teams خودکار",
        auto_zoom_meeting="📹 جلسه زوم خودکار",
