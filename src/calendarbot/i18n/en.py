...
""",
    ...
    inline=InlineTranslations(
        ...
        attendee_added="✅ Attendee added: {attendee}",
        attendee_removed="✅ Attendee removed: {attendee}",
        invalid_email_format="❌ Invalid email or username format. Use email@example.com or @username",
        # Link
