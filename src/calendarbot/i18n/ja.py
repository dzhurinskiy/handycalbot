...
""",
    ...
    settings=SettingsTranslations(
        ...
        outlook_calendar_label="Outlookカレンダー",
        ...
        connect_outlook_button="🔗 Outlookカレンダーを接続",
        outlook_disconnected="✅ Outlookカレンダーの接続が解除されました。\n再度接続するには /connectoutlook を使用してください。",
        no_outlook_connected="Outlookカレンダーが接続されていません。",
        connect_outlook_mode_title="**Outlookカレンダーを接続**\n\n接続モードを選択してください：",
        outlook_connected_status="**Outlookカレンダー接続済み** ✅\n\n現在のモード: {mode}\n\n以下でモードを切り替えるか、接続解除できます:",
    ...
    inline=InlineTranslations(
        ...
        auto_teams_meeting="📹 自動Microsoft Teams",
