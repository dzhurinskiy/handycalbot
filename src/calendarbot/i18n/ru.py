...
""",
    ...
    settings=SettingsTranslations(
        ...
        outlook_calendar_label="Outlook Календарь",
        ...
        connect_outlook_button="🔗 Подключить Outlook Календарь",
        outlook_disconnected="✅ Outlook Календарь успешно отключен.\nИспользуйте /connectoutlook для повторного подключения.",
        no_outlook_connected="Outlook календарь не подключен.",
        connect_outlook_mode_title="**Подключить Outlook Calendar**\n\nВыберите режим подключения:",
        outlook_connected_status="**Outlook Calendar Подключён** ✅\n\nТекущий режим: {mode}\n\nВы можете сменить режим или отключить ниже:",
    ...
    meetings=MeetingsTranslations(
        ...
        close_button="✖️ Закрыть",
        edit_button="✏️ Изменить",
        cancel_meeting_button="🗑️ Отменить",
        back_to_list_button="↩️ Назад к списку",
        closed="Список встреч закрыт.",
        # Edit menu
        edit_menu_title="✏️ **Редактировать Встречу**\n\nВыберите поле для редактирования:",
        edit_title_btn="📝 Название",
        edit_time_btn="🕐 Время",
        edit_date_btn="📅 Дата",
    ...
    inline=InlineTranslations(
        ...
        auto_teams_meeting="📹 Авто Microsoft Teams",
